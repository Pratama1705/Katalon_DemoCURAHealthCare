...
WebUI.setText(findTestObject('Object Repository/KatalonDemo - CURA Healthcare Service/Login/usernameFieldLoginPage'), 'John Doe')

WebUI.setEncryptedText(findTestObject('Object Repository/KatalonDemo - CURA Healthcare Service/Login/passwordFieldLoginPage'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')
